...
<nav class="navbar navbar-expand  navbar-white bg-white">
    ...
    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <a class="dropdown-item" href="#">헤어샾</a>
        <a class="dropdown-item" href="#">가발샾</a>
        <a class="dropdown-item" href="#">통가발</a>
        <a class="dropdown-item" href="#">반가발</a>
     </div>
	</div>
    
    <div>
        <img src="image\coomain.png" class="img-fluid" alt="main_image">
    </div>
